...
const WhoWeAre = () => {
  return (
    <section className="items-center text-center justify-center">
      ...
      <div className="text-left items-center justify-center p-20">
        <div>
          <p className="font-Lora-Medium text-[48px]">Our Believes</p>
          <p className="font-Poppins-Regular text-[30px] pb-10">
        ...
        <div>
          <p className="font-Lora-Medium text-[48px]">The Son of God</p>
          <p className="font-Poppins-Regular text-[30px] pb-10">
        ...
        <div>
          <p className="font-Lora-Medium text-[48px]">God, the Holy Ghost</p>
          <p className="font-Poppins-Regular text-[30px] pb-10">
        ...
        <div>
          <p className="font-Lora-Medium text-[48px]">The Bible</p>
          <p className="font-Poppins-Regular text-[30px] pb-10">
        ...
        <div>
          <p className="font-Lora-Medium text-[48px]">Salvation</p>
          <p className="font-Poppins-Regular text-[30px] pb-10">
        ...
        <div>
          <p className="font-Lora-Medium text-[48px]">Righteousness</p>
          <p className="font-Poppins-Regular text-[30px] pb-10">
        ...
        <div>
          <p className="font-Lora-Medium text-[48px]">Ordinance</p>
          <p className="font-Poppins-Regular text-[30px] pb-10">
        ...
        <div>
          <p className="font-Lora-Medium text-[48px] pb-5">Our Values</p>
          <ul className="pl-10">
            <li className="list-disc font-Poppins-Regular text-[30px] leading-10 pb-10">
        ...
        <div>
          <p className="font-Lora-Medium text-[48px] pb-5">Our Missions</p>
          <ul className="pl-10">
            <li className="list-disc font-Poppins-Regular text-[30px] leading-10 pb-10">
        ...
        <div>
          <p className="font-Lora-Medium text-[48px]">Our Motto</p>
          <p className="font-Poppins-Regular text-[30px] pb-10">
