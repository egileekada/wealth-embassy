    ...
    <section className=" ">
      <div className=" text-center " >
        ...
        <div className="relative  ">
          ...
          <div className="absolute flex items-center lg:px-0 px-8 justify-center flex-col inset-0">
            ...
            <p className="  font-Poppins-SemiBold text-[25px] text-center text-white lg:leading-10">
        ...
        <div className="text-left items-center lg:px-0 px-6 pt-8 lg:pt-0 justify-center lg:max-w-[1000px] lg:p-20">
          ...
          <div>
            ...
            <ul className="pl-10">
              <li className="list-disc font-Poppins-Regular text-[18px] lg:leading-10 pb-10">
